...
//Funzione che restituisce un valore con precisione a (0) cifre decimali 
...
string livella_to_MeasureSVG (Livella * mylivella) {
    ...
    str += "<text x=\"" + to_string(mylivella->mypiston1->pos_x1 + (mylivella->mypiston1->larg_1)/2) + "\" y=\"" + to_string(mylivella->mypiston1->pos_y1 + mylivella->mypiston1->alt_1 + 30) + "\" fill=\"white\">" + myValue(mylivella->mypiston1->larg_1) + "</text>";
    ...
    str += "<text x=\"" + to_string(mylivella->mypiston1->pos_x1 - 60) + "\" y=\"" + to_string(mylivella->mypiston1->pos_y1 + (mylivella->mypiston1->alt_1)/2) + "\" fill=\"white\">" + myValue(mylivella->mypiston1->alt_1) + "</text>\n";
    ...
    str += "<text x=\"" + to_string(mylivella->mypiston1->pos_x2 - 110) + "\" y=\"" + to_string(mylivella->mypiston1->pos_y2 + (mylivella->mypiston1->alt_2)/2) + "\" fill=\"white\">" + myValue(mylivella->mypiston1->alt_2) + "</text>\n";
    ...
    str += "<text x=\"" + to_string(mylivella->mypiston2->pos_x2 + 105) + "\" y=\"" + to_string(mylivella->mypiston2->pos_y2 + (mylivella->mypiston2->alt_2)/2) + "\" fill=\"white\">" + myValue(mylivella->mypiston2->alt_2) + "</text>\n";
    // Misura fra cilindri
    ...
    str += "<text x=\"" + to_string(mylivella->myplate->pos_x + (mylivella->myplate->lunghezza)/2) + "\" y=\"" + to_string(mylivella->myplate->pos_y - 40) + "\" fill=\"white\">" + myValue(mylivella->myplate->lunghezza) + "</text>\n";
    str += "</g> \n";
